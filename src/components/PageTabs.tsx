import { Plus, MoreVertical, Copy, Edit2, Trash2, Info } from "lucide-react";
    ...
    <div className="border-b border-border bg-card">
      <div className="max-w-7xl mx-auto px-8 flex items-center gap-4">
        ...
        <Button
          ...
          size="icon"
          onClick={onAddPage}
          className="flex-shrink-0 w-8 h-8 rounded-full bg-green-500 hover:bg-green-600 text-white"
